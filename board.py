...
if __name__ == "__main__":
    ...
    cboard.add_piece(shuai)
    cboard.add_piece(jiang)
    ...
    print(shi.act_list)
    shuai.get_act_list(cboard.bd_pos_status,cboard.bd_piece_status)
    print(shuai.act_list)
    jiang.get_act_list(cboard.bd_pos_status,cboard.bd_piece_status)
    print(jiang.act_list)